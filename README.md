...
<img src="https://github.com/leo-aa88.png?size=48" width="32" height="32" alt="reviewgate" align="left" /> **[reviewgate #172](https://github.com/leo-aa88/reviewgate/pull/172)** - corrects DESIGN.md section 10.14 Hunk entry state to match the shipped code-token rule from PR 144: each establishing context line must scan clean and carry a code token, with blank lines neutral, so docstring prose can no longer read as a normal code position.
