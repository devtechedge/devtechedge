...
**Web3:** Safe · Stellar · Wagmi · RainbowKit · ethers.js · Coinbase Wallet SDK · MetaMask SDK · Reown AppKit · Across Protocol · viem · Solana Web3.js · Ambire · thirdweb · Anza Kit

> The dedicated contribution repositories contain the detailed PR ledger, status history, issue claims, closed work, and pipeline decisions. They are the source of truth for the evolving contribution record.
