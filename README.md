...
<img src="https://github.com/stellar.png?size=48" width="32" height="32" alt="js-stellar-sdk" align="left" /> **[js-stellar-sdk #1725](https://github.com/stellar/js-stellar-sdk/pull/1725)** - docs pipeline now covers docs/migration pages: Starlight sidebar group, llms.txt and llms-full.txt bundles with strict link validation, wired through astro.config.mjs, build-llms.ts and doc-links.ts.
